  ...
  return (
    <div className='pt-[86px] pb-[107px] px-6 md:px-10 lg:px-32 relative overflow-hidden bg-bggreen'>
      ...
      <p className='max-w-[683px] mx-auto text-[22px] rale'>Land your dream job effortlessly – we apply, update, and keep you ahead in your career</p>
        <div className='mapbg bg-center h-[651px]  w-full grid grid-cols-1 lg:grid-cols-2 gap-10 items-center '>
    ...
    <img src="/assets/comma.png" alt="comma" className='absolute rotate-180 right-6 bottom-6' />
            ...
            <div className='w-full h-fit max-w-[550px] relative'>
                <img src="/assets/familyCircle.png" alt="circle" />
                <div className='py-4 px-6 bg-white rounded-[24px] w-full max-w-[270px] absolute top-24 left-24 z-20 gap-3 flex flex-col'>
                    <div className='flex items-center  gap-3'>
                        ...
                        <div>
                            ...
                            <h1 className='text-757 text-sm flex items-center justify-center pl-6'>hired by: <img src="/assets/ball.png" alt="ball" /> dribble</h1>

                </div>
                <div className='py-4 px-6 bg-white rounded-[24px] w-full max-w-[270px] absolute top-1/2 -translate-y-1/2 left-0 z-20 gap-3 flex flex-col'>
                    <div className='flex items-center  gap-3'>
                ...
                <div className='py-4 px-6 bg-white rounded-[24px] w-full max-w-[270px] absolute top-1/2 -translate-y-1/2 -right-3 z-20 gap-3 flex flex-col'>
                    <div className='flex items-center  gap-3'>
                ...
                <div className='py-4 px-6 bg-white rounded-[24px] w-full max-w-[270px] absolute bottom-24 right-20 z-20 gap-3 flex flex-col'>
                    <div className='flex items-center  gap-3'>
