...
const FAQs = () => {
    ...
    return (
        <div className='pt-[86px]  px-6 md:px-10 lg:px-32 relative overflow-hidden bg-bggreen'>
...
<div className='bg-green p-4 mr-auto rounded-xl w-full max-w-[380px] flex justify-between items-center'>
