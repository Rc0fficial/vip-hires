const HeartFilledIcon = ({ height , width,color,className,onClick }) => {
	return (
		<svg onClick={onClick} className={className} height={height} width={width} fill="none" viewBox="0 0 34 33" xmlns="http://www.w3.org/2000/svg">
			<g>
