    ...
    return (
        <>
            ...
            <div className={`col-span-2 rounded-3xl py-10 px-12 bg-white shad     `}>
                ...
                <h1 className='font-semibold capitalize text-2xl text-3d3'>Devices that remember your password</h1>
                <h4 className='text-989 mb-6 mt-3'>Manage the devices that have saved your password for quick and easy access.</h4>
                ...
                <div className='flex flex-col '>
                    <div className='flex justify-between items-center pb-6 border-b border-dcd mb-6'>
                        ...
                        <button className='text-ff6 text-lg font-medium flex justify-center items-center gap-3 px-8 py-1.5 rounded-full border border-ff6'><TrashIcon height={24} width={24} color={'#FF6161'} /> Logout</button>
