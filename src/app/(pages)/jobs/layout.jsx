...
const JobsLayout = ({ children }) => {
  ...
  return (
    <div className="bg-bggreen"> 
      <div className="bg-bggreen sticky top-0 z-10 px-12 md:px-16 mx-auto">
        <div className="w-full mx-auto grid grid-cols-1 gap-10 py-10 lg:grid-cols-3">
          {/* Left Sidebar - Sticky with scrollable content */}
          <div className="col-span-1 flex flex-col sticky top-[0px] h-[75vh]">
                ...
                <div className="flex flex-col gap-6 border-l-4 border-[#C5DDFB]">
                  ...
                  <div
                    className={`pl-4 border-l-4 ${
                      pathname === "/jobs" ? "border-l-green" : "border-l-[#C5DDFB]"
                    } -ml-1`}
                  >
                    <button
                  ...
                  <div
                    className={`pl-4 border-l-4 ${
                      pathname === "/jobs/ai-jobs" ? "border-l-green" : "border-l-[#C5DDFB]"
                    } -ml-1`}
                  >
                    <button
                      disabled
                  ...
                  <div
                    className={`pl-4 border-l-4 ${
                      pathname === "/jobs/my-applications" ? "border-l-green" : "border-l-[#C5DDFB]"
                    } -ml-1`}
                  >
                    <button
                  ...
                  <div
                    className={`pl-4 border-l-4 ${
                      pathname === "/jobs/saved-jobs" ? "border-l-green" : "border-l-[#C5DDFB]"
                    } -ml-1`}
                  >
                    <button
          ...
          {/* Main Content */}
          <div
            className={`col-span-2 rounded-3xl h-[calc(100vh-116px)] overflow-y-auto ${
              pathname === "/jobs/my-applications" ? "" : "py-10 px-12 bg-white shad"
            }`}
          >
            {children}
          </div>
