...
const JobDetail = () => {
    return (
        <>
        <div className='rounded-3xl h-fit  bg-white py-10 px-12  shad'>
            {/* job description */}
            <div className='flex flex-col mb-4'>

                <h1 className='text-xl font-medium text-525 capitalize mb-4'>Job Description :</h1>
                <p className='text-989 tracking-[0.3px] leading-[25px] pb-4 border-dcd border-b'>One disadvantage of Lorum Ipsum is that in Latin certain letters appear more frequently than others - which creates a distinct visual impression. Moreover, in Latin only words at the beginning of sentences are capitalized.<br />
            ...
            <div className="mb-6">
                <h2 className='text-xl font-medium text-525 capitalize mb-4'>
                    Responsibilities And Duties :
                </h2>
                <p className="text-989 mb-4">
                    It sometimes makes sense to select texts containing the various
                    letters and symbols specific to the output language.
                </p>
                <ul className="list-disc pl-6 text-989 space-y-2">
...
<div className='rounded-3xl h-fit  bg-white py-10 px-12 mt-6 shad grid grid-cols-1 lg:grid-cols-2 gap-6'>
