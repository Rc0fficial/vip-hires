            ...
            <div className="bg-bggreen overflow-y-auto px-12 md:px-16  mx-auto ">
                <div className="w-full mx-auto grid grid-cols-1 gap-10 py-10 lg:grid-cols-3">
                    <div className="col-span-1 full flex flex-col justify-between ">
                        <div className='h-fit bg-white p-10 rounded-3xl shad'>

                            <div className='flex justify-between pb-4 border-b border-dcd mb-4'>

                                <h1 className='capitalize text-2xl text-3d3 group-hover:text-white font-medium leading-[20px] '>ui/ux designer</h1>
                            ...
                            <div className='flex items-center gap-4 mt-8'>
                                <button className='py-2.5 capitalize rounded-md text-lg text-white group-hover:text-green group-hover:bg-white font-semibold bg-green px-6 flex-1'>apply on my behalf</button>
                                <button className='h-12 w-12 rounded-md capitalize text-lg group-hover:border-white font-semibold border border-green   flex  justify-center items-center'><UrlIcon className="group-hover:stroke-white group-hover:fill-green fill-white  stroke-green" color={"#009969"} height={24} width={24} /></button>
