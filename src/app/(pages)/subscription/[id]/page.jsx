    ...
    return (
        ...
        <div className='pt-[86px] pb-[107px]  md:px-10 relative overflow-hidden bg-white'>
            <div className=' mx-auto px-6 flex justify-between items-center z-10 flex-col  gap-6 '>
                <h1 className='text-2xl md:text-5xl lg:text-[56px] font-extrabold robo text-center text-0f1 capitalize'>a <span className='relative'>plan <img src="/assets/underline2.png" alt="underline" className='absolute w-[55px] h-[9px]  -bottom-2 right-2' /></span> made just for you</h1>
                <p className=' mx-auto md:text-[22px] text-center robo text-0f1 mb-16'>Choose a plan that fits your career goals  from job applications to LinkedIn growth, we’ve got you covered</p>
                ...
                <div className='grid grid-cols-3 gap-8 z-30'>
                    <div className='col-span-3 lg:col-span-2 bg-white/80 shad p-4 md:p-8 rounded-3xl '>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <div className='mb-8'>
                                <h1 className='mont md:text-[32px] font-bold text-3d3'>Upgrade to pro plan</h1>
                            ...
                            <form action="">
                                ...
                                <div className='grid grid-cols-2 md:grid-cols-3 gap-3'>
                                    <div className='py-4 px-5 border rounded-xl border-[#BDBDBD]'>
                                        ...
                                        <h1 className='md:text-xl text-525 mt-3'>Credit Card</h1>
                                    </div>
                                    <div className='py-4 px-5 border rounded-xl border-[#BDBDBD]'>
                                        <BankIcon height={24} width={24} color={"#525252"} />
                                        <h1 className='md:text-xl text-525 mt-3'>Bank Transfer</h1>
                                    </div>
                                    <div className='py-4 px-5 border rounded-xl border-[#BDBDBD]'>
                                        <PaypalIcon height={24} width={24} color={"#525252"} />
                                        <h1 className='md:text-xl text-525 mt-3'>Paypal</h1>
                                    </div>
                                ...
                                <p className='mt-8 text-[#707F8F] text-sm md:text-[16px]'>By providing your card information, you allow us to charge your card for future payment in accordance with their terms.</p>
